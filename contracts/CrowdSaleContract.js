...
const web3 = new Web3(
  "https://virtual.binance.rpc.tenderly.co/38d3e9fd-82ad-4535-baa4-47295e9f82c8"
);

export const address = "0x595d87d3a58ce0cf1fd08b06b242d7e9f61c3805";
export const abi = [
  {
    inputs: [
...
const CrowdSaleContract = new web3.eth.Contract(abi, address);
